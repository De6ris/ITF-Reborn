...
public class Items extends Item {
    ...
    public static void registerItems(ItemRegistryEvent event) {
        ...
        event.register("ingot/nickel", nickelIngot);
        event.register("ingot/nugget/nickel", nickelNugget);
        event.register("tool/nickel/nickel_axe", nickelAxe);
        event.register("tool/nickel/nickel_battle_axe", nickelBattleAxe);
        event.register("tool/nickel/nickel_dagger", nickelDagger);
        event.register("tool/nickel/nickel_hatchet", nickelHatchet);
        event.register("tool/nickel/nickel_hoe", nickelHoe);
        event.register("tool/nickel/nickel_knife", nickelKnife);
        event.register("tool/nickel/nickel_pickaxe", nickelPickaxe);
        event.register("tool/nickel/nickel_mattock", nickelMattock);
        event.register("tool/nickel/nickel_scythe", nickelScythe);
        event.register("tool/nickel/nickel_shears", nickelShears);
        event.register("tool/nickel/nickel_shovel", nickelShovel);
        event.register("tool/nickel/nickel_sword", nickelSword);
        event.register("tool/nickel/nickel_war_hammer", nickelWarHammer);
        event.register("door/nickel", doorNickel);
        event.register("chain/nickel", nickelChain);
        event.register("coin/nickel", nickelCoin);
        ...
        event.register("ingot/tungsten", tungstenIngot);
        event.register("ingot/nugget/tungsten", tungstenNugget);
        event.register("tool/tungsten/tungsten_axe", tungstenAxe);
        event.register("tool/tungsten/tungsten_battle_axe", tungstenBattleAxe);
        event.register("tool/tungsten/tungsten_dagger", tungstenDagger);
        event.register("tool/tungsten/tungsten_hatchet", tungstenHatchet);
        event.register("tool/tungsten/tungsten_hoe", tungstenHoe);
        event.register("tool/tungsten/tungsten_knife", tungstenKnife);
        event.register("tool/tungsten/tungsten_pickaxe", tungstenPickaxe);
        event.register("tool/tungsten/tungsten_mattock", tungstenMattock);
        event.register("tool/tungsten/tungsten_scythe", tungstenScythe);
        event.register("tool/tungsten/tungsten_shears", tungstenShears);
        event.register("tool/tungsten/tungsten_shovel", tungstenShovel);
        event.register("tool/tungsten/tungsten_sword", tungstenSword);
        event.register("tool/tungsten/tungsten_war_hammer", tungstenWarHammer);
        event.register("door/tungsten", doorTungsten);
        event.register("chain/tungsten", tungstenChain);
        event.register("coin/tungsten", tungstenCoin);
        ...
        event.register("tool/copper/copper_club", morningStarCopper);
        event.register("tool/silver/silver_club", morningStarSilver);
        event.register("tool/gold/gold_club", morningStarGold);
        event.register("tool/iron/iron_club", morningStarIron);
        event.register("tool/nickel/nickel_club", morningStarNickel);
        event.register("tool/ancient_metal/ancient_metal_club", morningStarAncientMetal);
        event.register("tool/mithril/mithril_club", morningStarMithril);
        event.register("tool/tungsten/tungsten_club", morningStarTungsten);
        event.register("tool/adamantium/adamantium_club", morningStarAdamantium);
        ...
        event.register("tool/vibranium/vibranium_sword", VibraniumSword);
        ...
        event.register("ingot/uru", UruIngot);
        event.register("ingot/nugget/uru", UruNugget);
        event.register("tool/uru/uru_battle_axe", UruBattleAxe);
        event.register("tool/uru/uru_mattock", UruMattock);
        event.register("tool/uru/uru_scythe", UruScythe);
        event.register("tool/uru/uru_sword", UruSword);
        event.register("tool/uru/uru_war_hammer", UruWarHammer);
        event.register("tool/uru/uru_club", UruMorningStar);
        event.register("tool/uru/uru_pickaxe", UruPickaxe);
