...
public class PotionExtend extends Potion {
    ...
    public static final Potion stretch = new PotionExtend(getNextPotionID(), false, 114514).setIconIndex(6, 2).setPotionName("potion.extend.stretch");
    public static final Potion warm = new PotionExtend(getNextPotionID(), false, 16744448).setIconIndex(7, 2).setPotionName("potion.extend.warm");
    public static final Potion cool = new PotionExtend(getNextPotionID(), false, 10092544).setIconIndex(7, 2).setPotionName("potion.extend.cool");
    public static final Potion frost_resistance = new PotionExtend(getNextPotionID(), false, 10092544).setIconIndex(7, 2).setPotionName("potion.extend.frost_resistance");
