...
public class ItemGuideBook extends ItemEditableBook {
  ...
  public static NBTTagCompound generateBookContents() {
    ...
    nbt.setTag("author", (NBTBase)new NBTTagString("author", "Schwartz & Xy_lose"));
    nbt.setTag("title", (NBTBase)new NBTTagString("title", "* GUIDE *"));
    pages.appendTag((NBTBase)new NBTTagString("1", "* GUIDE *\n该指南的扉页部分只负责解决游戏内技术性问题，如有需要了解部分更新内容请跳转05页。\n\n注意：我们不会提供一些机制对应的所有解决方案！"));
    pages.appendTag((NBTBase)new NBTTagString("2", "有关渲染问题：请再三确认游戏使用的显卡：Intel核心显卡需要回滚老版本驱动(实际版本未测试)，如果需要通过更换其他显卡解决渲染问题，可以参考后页的步骤。"));
    pages.appendTag((NBTBase)new NBTTagString("3", "NVIDIA显卡只需正常更新驱动，在桌面右键菜单可以找到NVIDIA控制面板，在「管理3D设置」项内选择「首选图形处理器」为「高性能」。AMD显卡在近期的驱动更新中可能导致内存泄露，如有需要可前往官网回滚更新。"));
    pages.appendTag((NBTBase)new NBTTagString("4", "再三重申：模组内自带的坐标器和时间显示需要拿取特定物品如时钟、指南针以显示。"));
    pages.appendTag((NBTBase)new NBTTagString("5", "*有关水分 7-12页\n*有关熔炉 13页\n*有关矿物规划 14-15页\n*有关金苹果 16页\n*有关新金属 17-19页"));
    pages.appendTag((NBTBase)new NBTTagString("6", "*有关新生物群系 20-21页\n*有关额外机制 22-26页\n*有关新物品 29-32页\n*附页 33页+"));
    pages.appendTag((NBTBase)new NBTTagString("7", "在游玩模组时，作者默认「玩家」(下称「你」)已经游玩过MITE R196并拥有一定的理论知识，同时一部分已有的无关痛痒的机制碍于篇幅不再赘述。"));
    pages.appendTag((NBTBase)new NBTTagString("8", "位于玩家状态栏右下角饱食度上方的即模组新添加的水分条，依然会随时间推移减少，在玩家食用特定食物时将直接减少或者增加。"));
    pages.appendTag((NBTBase)new NBTTagString("9", "在食用肉类时这个条会立即减少，在它为空时玩家将逐渐减少血量直到死亡；留意一些新的花和仙人掌，在合成后将触发一个新的成就：紧急避险。对应的合成产物可以在你做出碗之前恢复含水量。"));
    pages.appendTag((NBTBase)new NBTTagString("10", "如果对水分拥有迫切的需求，你可以在水中按住潜行键并保持一段时间，这也会让你恢复一部分水分。\n\n至此，你可以正常前进到燧石工具时代了。"));
    pages.appendTag((NBTBase)new NBTTagString("11", "在做出碗舀取水分乃至你在水中潜行获得debuff时，你可能会留意到多数地区的水饮用之后会出现问题，你可以使用黏土炉去蒸馏「一碗可疑的水」或者「一碗沼泽水」来让水变得安全(务必参考p31)。"));
    pages.appendTag((NBTBase)new NBTTagString("12", "一些河流部分段落的水可能无需烧炼即可饮用而不会获取debuff，这也在水质的考虑范围之内。同时你需要干净的水来制作相关的碗类食物，牛奶也不失为一种补水的选择。"));
    pages.appendTag((NBTBase)new NBTTagString("13", "MITE-ITF的熔炉需要使用打火石右键启动，一些看起来明显带火的玩意(除了火把)也可用来作为火引子；一些物品可能不耐高温；在熔炉熄灭之前你不需要再次点火；\n\n直接用火烧掉落状态的肉不失为一种选择。"));
    pages.appendTag((NBTBase)new NBTTagString("14", "在玩家做出第一把铜镐挖掘矿物时，你可能会惊讶于矿物的掉落，保持淡定。按照R196的第一把镐的规划先石头再煤炭最后铜矿即可，在熔炉中将之冶炼成金属粒并合成，保持你的耐心。"));
    ...
    pages.appendTag((NBTBase)new NBTTagString("33", "* 配置文件 *\n详见「Configs/MITE-Is-Too-Flase-CFG.json」，你也可以输入/configs edit指令快速修改配置，按照正常流程更改其中的配置可以让玩家体验到更加不一样的MITE-ITF。"));
