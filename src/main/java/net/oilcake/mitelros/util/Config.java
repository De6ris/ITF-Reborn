...
public class Config {
    ...
    public static final FieldReference<Boolean> TagDemonDescend = new FieldReference(false);
    public static final FieldReference<Boolean> TagDimensionInvade = new FieldReference(false);
    ...
    public static final ConfigRoot StuckTags = ConfigRoot.create(Constant.CONFIG_VERSION)
            .addEntry(ConfigCategory.of("挑战")
                    .addEntry(ConfigCategory.of("自然恶意")
                            ...
                            .addEntry(ConfigEntry.of("dimension_invade", TagDimensionInvade).withComment("(LVL4)维度入侵：除了末地之外的任何维度都会生成其他维度的敌对生物"))
                    )
                    .addEntry(ConfigCategory.of("疯狂劲敌")
                            ...
                            .addEntry(ConfigEntry.of("demon_descend", TagDemonDescend).withComment("(LVL2)恶魔降临：僵尸猪人领主血量提升50%，攻击力提升25%，概率手持钨钉头锤，且会召唤猪人守卫支援"))
                    )
