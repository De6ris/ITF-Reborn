...
//          int block_id = world.getBlockId(serverPlayer.getBlockPosX() + tempX, serverPlayer.getBlockPosY() + tempY, serverPlayer.getBlockPosZ() + tempZ);
//          if (block_id == block_id_to_clear) {
//            world.setBlockToAir(serverPlayer.getBlockPosX() + tempX, serverPlayer.getBlockPosY() + tempY, serverPlayer.getBlockPosZ() + tempZ);
//            executes++;
//          }
//        }
//      }
