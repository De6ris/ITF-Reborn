...
public class WorldGenNetherBridgeCorridor1Mixin extends StructureComponent {
  ...
  public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
    ...
    if (this.field_111020_b) {
      ...
      int var5 = getXWithOffset(1, 3);
      int var6 = getZWithOffset(1, 3);
      if (par3StructureBoundingBox.isVecInside(var5, i, var6)) {
        this.field_111020_b = false;
        generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 1, 2, 3, Block.chest.blockID, chest_contents, 2 + par2Random.nextInt(4), (float[])null, (par2Random.nextInt(2) == 0) ? EnumDirection.SOUTH : EnumDirection.EAST);
      } 
    } 
