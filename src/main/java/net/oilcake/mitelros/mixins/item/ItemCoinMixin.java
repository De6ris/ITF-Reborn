...
public class ItemCoinMixin extends Item {
  ...
  public Item getNuggetPeer() {
    ...
    if (material == Materials.nickel)
      return (Item)Items.nickelNugget; 
    if (material == Materials.tungsten)
      return (Item)Items.tungstenNugget; 
    return (material == Material.copper) ? (Item)Item.copperNugget : ((material == Material.silver) ? (Item)Item.silverNugget : ((material == Material.gold) ? (Item)Item.goldNugget : null));
  }
}
