...
public class RecipesMITEMixin {
    ...
    public static void addFurnaceRecipes(FurnaceRecipes furnace_recipes) {
        ...
        furnace_recipes.addSmelting(Block.oreLapis.blockID, new ItemStack((Item) Items.lapis, 4));
        ...
        for (int i = 0; i < Item.itemsList.length; i++) {
            ...
            if (item instanceof ItemFood) {
                ...
                if (food.getCookedItem() != null)
                    furnace_recipes.addSmelting(i, new ItemStack((Item) food.getCookedItem()));
            }
        }
    }
}
