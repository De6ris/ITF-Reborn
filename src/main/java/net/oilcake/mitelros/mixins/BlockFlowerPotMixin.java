...
public class BlockFlowerPotMixin extends Block {
  ...
  public static ItemStack getPlantForMeta(int par0) {
    switch (par0) {
      case 1:
        return new ItemStack((Block)Block.plantRed);
      case 2:
        return new ItemStack((Block)Block.plantYellow);
      case 3:
      ...
      case 7:
        return new ItemStack((Block)Block.mushroomRed);
      case 8:
        return new ItemStack((Block)Block.mushroomBrown);
      case 9:
        return new ItemStack(Block.cactus);
      case 10:
        return new ItemStack((Block)Block.deadBush);
      case 11:
        return new ItemStack((Block)Block.tallGrass, 1, 2);
      case 12:
        return new ItemStack((Block)Block.deadBush, 1, 1);
      case 13:
        return new ItemStack((Block)Blocks.flowerextend);
    } 
    return null;
  }
