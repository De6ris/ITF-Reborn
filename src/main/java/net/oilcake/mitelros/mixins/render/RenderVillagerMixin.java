...
public abstract class RenderVillagerMixin extends RenderLiving {
  ...
  protected void setTextures() {
    setTexture(0, "textures/entity/villager/villager");
    setTexture(1, "textures/entity/villager/farmer");
    setTexture(2, "textures/entity/villager/librarian");
    setTexture(3, "textures/entity/villager/priest");
    setTexture(4, "textures/entity/villager/smith");
    setTexture(5, "textures/entity/villager/butcher");
  }
