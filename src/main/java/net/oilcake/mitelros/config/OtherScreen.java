...
public class OtherScreen extends GuiScreenCommented {
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        ...
        switch (par1GuiButton.id) {
            case 0:
                this.mc.displayGuiScreen(new ValueScreen(this, "信息显示", this.configs.setValues(ITFConfig.info)));
                break;
            case 1:
                this.mc.displayGuiScreen(new ValueScreen(this, "杂项", this.configs.setValues(ITFConfig.misc)));
                break;
            case 3:
